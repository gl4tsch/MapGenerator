...
public class DelaunayTriangulation {
    ...
    public static List<Triangle> MakeTriangulationDelaunay(List<Triangle> triangles)
    {
    ...
    public static List<Triangle> FillInNeighbours(List<Triangle> triangles)
    {
        foreach(Triangle t in triangles)
        {
            if (!t.v1.Neighbours.Contains(t.v2))
            {
                t.v1.Neighbours.Add(t.v2);
            }
            if (!t.v1.Neighbours.Contains(t.v3))
            {
                t.v1.Neighbours.Add(t.v3);
            }
            if (!t.v2.Neighbours.Contains(t.v1))
            {
                t.v2.Neighbours.Add(t.v1);
            }
            if (!t.v2.Neighbours.Contains(t.v3))
            {
                t.v2.Neighbours.Add(t.v3);
            }
            if (!t.v3.Neighbours.Contains(t.v1))
            {
                t.v3.Neighbours.Add(t.v1);
            }
            if (!t.v3.Neighbours.Contains(t.v2))
            {
                t.v3.Neighbours.Add(t.v2);
            }
        }
        return triangles;
    }
